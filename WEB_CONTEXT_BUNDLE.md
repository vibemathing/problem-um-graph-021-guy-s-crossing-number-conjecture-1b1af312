...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-021"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-v1",
      "problem_contract_sha256": "bb06da2a5e8c2b36b551c9a87c741568b2623ac58d4bba8705a9497fc9d2ff75",
      "problem_id": "problem:um-graph-021-guy-s-crossing-number-conjecture-1b1af312",
      "route_id": "route:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-source-fidelity-01",
      "graph_id": "graph:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is the crossing number of the complete graph $K_n$ equal to the value given by Guy's formula?"
          },
          "statement_sha256": "1ebbd685b7a33bdd6b5d922acb20035a3e12394a03e2941b2cd648af398d69f5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-root",
      "route_id": "route:um-graph-021-guy-s-crossing-number-conjecture-1b1af312-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-021-2d5c93d5e487",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-021"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
